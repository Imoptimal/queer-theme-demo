...
// Dropdown menu
jQuery(function($) {
    var menuHandle = $('.queerthm-container .site-header .dropdown-menu .handle');
    var menuToggler = $('.queerthm-container .site-header .dropdown-menu .toggle');
    var headerMenu = $('.queerthm-container .site-header .dropdown-menu .header-menu');
    var searchHandle = $('.queerthm-container .site-header .search-toggle .handle');
    var searchToggler = $('.queerthm-container .site-header .search-toggle .toggle');
    var searchForm = $('.queerthm-container .site-header .search-toggle #searchform');
    ...
    var menuCloseButton = $('.queerthm-container .site-header .dropdown-menu .close-menu');
    var menuAutoClose = $('.queerthm-container .site-header .dropdown-menu .auto-close');
    $(searchForm).prepend('<a class="close-menu" href="#"></a>');
    $(searchForm).append('<a class="auto-close" href="#"></a>');
    var searchCloseButton = $('.queerthm-container .site-header .search-toggle .close-menu');
    var searchAutoClose = $('.queerthm-container .site-header .search-toggle .auto-close');
